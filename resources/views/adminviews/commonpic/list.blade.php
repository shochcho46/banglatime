...
<div class="container-fluid">
    ...
    <div class="row">
        <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 col-xl-12 ">
         <form method="POST"   id="newsid" action="{{ route('Commonpicture.newssearch') }}" enctype="multipart/form-data">
                 @csrf
    ...
    <div class="row">
        ...
        <div class="col-8">
            ...
            <div class="row">
                <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 col-xl-12">
                    <form method="POST"  class="form-row" id="newsid" action="{{ route('Commonpicture.picdate') }}" enctype="multipart/form-data">
                        @csrf
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td class="align-middle">
                        ...
                        <a class="btn btn-outline-primary btn-sm" href="{{ route('Commonpicture.edit',$value->id) }}">
                        ...
                        <a class="btn btn-outline-danger btn-sm" href="{{ route('Commonpicture.destroy',$value->id) }}"
                        ...
                        <form method="POST" id="del{{$value->id}}" action="{{ route('Commonpicture.destroy', $value->id) }}"
                            style="display: none;">
                            @csrf
                            @method('DELETE')
                        </form>
