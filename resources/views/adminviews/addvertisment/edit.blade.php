...
<div class="container">
    ...
    <div class="card">
        <div class="card-body">
            <form method="POST" id="newsid" action="{{ route('addvertisment.update',$add->id) }}" enctype="multipart/form-data">
                @csrf
                @method('PUT')
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="url" name="url"  placeholder="www.example.com" value="{{ old('url') ?? $add->url }}"required>
                </div>
                ...
                <div class="form-group">
                    ...
                    <option value="{{ $add->type }}" selected disabled>Choose...</option>
                ...
                <div class="form-group">
                  ...
                  <div class="form-group">
                    {{-- @foreach($picture as $pic) --}}
                        <img class=" img-thumbnail" width="80px" height="80px" src="{{$add->location}}" alt="Card image cap">
                    {{-- @endforeach --}}
                </div>
